...
% modified by Dan Buscombe Apr 2012 to have output handle and also a new
% field in appDataStruct which says whether the zoom is on or not

function appDataStruct = magnifyOnFigure( varargin )
